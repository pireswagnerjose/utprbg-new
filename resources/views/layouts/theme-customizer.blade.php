<div id="customizerButton" drawer-end="" class="fixed inset-y-0 flex flex-col w-full transition-transform duration-300 ease-in-out transform bg-white shadow ltr:right-0 rtl:left-0 md:w-96 z-drawer show dark:bg-zink-600">
    <div class="flex justify-between p-4 border-b border-slate-200 dark:border-zink-500">
        <div class="grow">
            <h5 class="mb-1 text-16">Personalizar Tema</h5>
            <p class="font-normal text-slate-500 dark:text-zink-200">Escolha seu tema e layout.</p>
        </div>
        <div class="shrink-0">
    ...
    <div class="h-full p-6 overflow-y-auto">
        <div>
            <h5 class="mb-3 underline capitalize text-15">Escolha O layouts</h5>
        ...
        <div class="mt-6">
            <!-- data-content -->
            <h5 class="mb-3 underline capitalize text-15">Largura do Conteúdo</h5>
            <div class="flex gap-3">
        ...
        <div class="mt-6" id="sidebar-size">
            <!-- data-sidebar-size="" -->
            <h5 class="mb-3 underline text-15">Tamanho da Barra Lateral</h5>
            <div class="flex flex-wrap gap-3">
        ...
        <div class="mt-6" id="navigation-type">
            <!-- data-navbar="" -->
            <h5 class="mb-3 underline text-15">Tipo de Navegação</h5>
            <div class="flex flex-wrap gap-3">
        ...
        <div class="mt-6" id="sidebar-color">
            ...
            <h5 class="mb-3 underline text-15">Cores do Menu Lateral</h5>
            <div class="flex flex-wrap gap-3">
        ...
        <div class="mt-6">
            ...
            <h5 class="mb-3 underline text-15">Cores da Barra Superior</h5>
            <div class="flex flex-wrap gap-3">
